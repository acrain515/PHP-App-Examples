...
<?php 
  ...
  //fwrite($myfile, "<?php \n\n");
    ...
    echo 'Vendor: ' . $vendor . '</br>';
	  ...
	  $customer= round($row['SAVINGS']);
		$customer= substr($customer,0,-3);
    ...
    echo 'Customer: ' . $customer . '</br>';
	  ...
	  $traffic= round($row['SAVINGS']);
		$traffic= substr($traffic,0,-3);
		
    echo 'Vendor: ' . $traffic . '</br>';
    ...
    echo 'FOC Received: ' . $foc . '</br>';
		...
		//SUM ALL FOR TOTAL
		$total= $foc+$vendor+$prov+$design+$customer+$traffic;
