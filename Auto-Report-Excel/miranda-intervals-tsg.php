<!DOCTYPE html>
<head>
<title>Miranda Intervals TSG</title>
<style>
...
<?php
  ...
  $result= $local->query("Select * from Tasks_$system where (PARENT_QUEUE in $parent or QUEUE in $parent) and RELEASE_DATE!=''");
