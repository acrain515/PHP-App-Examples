<?php
  ...
  $resultX= $local->query("Truncate table Tasks_PAE");
  ...
  --left join SIM.M6_SVCREQ_PROVPLAN@oltp d
  --on a.REQ_PLAN_ID=d.REQ_PLAN_ID
  --left join SIM.M6_PROVISIONING_PLAN@oltp e
  ...
  while ($row = oci_fetch_array($result, OCI_ASSOC+OCI_RETURN_NULLS)) {
	...
	$result2= $local->query("Insert into Tasks_PAE (PARENT_QUEUE,QUEUE,DOCUMENT_NUMBER,TASK_NUMBER,TASK,STATUS,SCHED_COMP_DATE,
