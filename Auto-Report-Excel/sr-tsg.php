<?php
  ...
  $resultX= $local->query("Truncate table Service_Requests_TSG");
  ...
  while ($row = oci_fetch_array($result, OCI_ASSOC+OCI_RETURN_NULLS)) {
	...
	$result2= $local->query("Insert into Service_Requests_TSG (DOCUMENT_NUMBER,ORDER_NUMBER,COMP_DATE,ACT_TYPE,SUP,OWNER)
