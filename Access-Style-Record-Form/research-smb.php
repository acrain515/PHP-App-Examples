...
Show: <select style="width:60px;" name="limit" onchange="this.form.submit()">
  ...
  <tr>
	...
	<tbody>
  <form method="post" action="research-smb.php">

<?php

  $e=0;
	
	$query= "Select ID,LEC_CKT_CLN,BAN,MRC,BILL_ACCT,INTERNAL_CKT,PROJECT,SUBPROJECT,RESEARCHER,RESEARCH_STATUS,RESEARCH_DATE,SOFT_DISC_DATE,DISC_STATUS,TO_LEC_DATE,FOC_DATE from Dbb where PSR_USER in ('SMB','Residential') $search $sort limit $limit";
