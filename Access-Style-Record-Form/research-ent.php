...
<form method="post" action="research-ent.php">
...
<?php
  ...
  $e=0;
	...
	$query= "Select ID,LEC_CKT_CLN,BAN,MRC,BILL_ACCT,INTERNAL_CKT,PROJECT,SUBPROJECT,RESEARCHER,RESEARCH_STATUS,RESEARCH_DATE,SOFT_DISC_DATE,DISC_STATUS,TO_LEC_DATE,FOC_DATE from Dbb where PSR_USER='ENT' $search $sort limit $limit";
