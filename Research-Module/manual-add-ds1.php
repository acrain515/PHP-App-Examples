...
<?php
	...
	if(isset($_POST['ds1For'])) {  
	
	  $ds1For= $_POST['ds1For'];
	
	  //echo 'ds1For: ' . $ds1For . '</br>';
		
		if($ds1For=='mileage') {  ?>
		
		  <div id="searchForm">
	      <form method="post" action="manual-add-ds1-mileage.php">
		      <table style="border:1px solid #ccc;">
		        <tr><td><b>LEC Circuit ID: </b></td></tr>
			      <tr><td>&nbsp;</td></tr>
		        <tr><td><input type="text" name="lecCkt"></td></tr>
			      <tr><td style="text-align:center;"><input type="submit" value="NEXT"/></td></tr>
		      </table>
        </form>
      </div>
		...
		<?php
		  ...
		  <div id="searchForm">
	      <form method="post" action="manual-add-ds1-clear.php">
		      <table style="border:1px solid #ccc;">
		        <tr><td><b>Internal Circuit ID: </b></br><span style="font-size:11px;"><i>include slashes</i></span></td></tr>
			      <tr><td>&nbsp;</td></tr>
		        <tr><td style="width:200px;"><input style="width:200px;" type="text" name="internalCkt"</td></tr>
			      <tr><td style="text-align:center;"><input type="submit" value="NEXT"/></td></tr>
		      </table>
        </form>
      </div>
