...
<form method="post" action="tracking-trro.php">
...
<?php
  ...
  $e=0;
	...
	$query= "Select ID, INTERNAL_ORDER,SUBPROJECT,LATA,VENDOR_CKT_CLN, INTERNAL_CKT_CLN, VENDOR_CFA, STATUS, DATE_ADDED, INITIAL_FOC, NEW_VENDOR_CKT, PLANNER, NOGO, NOGO_REASON from Simple where INTERNAL_ORDER in ('TRRO') $search $sort limit $limit";
...
<div style="width:200px;height:100px;padding:10px;margin:0 10px;border:1px solid #ccc;float:left;">
  <div style="float:left;"><b>Import Edit</b></div>
	...
	<div style="clear:both;"></div>
  <iframe style="height:80px;" src="import-edit-trro.php" frameborder="0" scrolling="no"></iframe>
</div>
