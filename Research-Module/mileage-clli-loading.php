...
<body>
  ...
  <div id="main">
	...
	<?php if(isset($_GET['clli'])) { $clli= $_GET['clli']; } ?>
...
<script>
$.post( "mileage-clli-write.php?clli=<?php echo $clli; ?>", function( data ) {
     //$("#imgId").hide(); // Hide loading image.
	 
     window.location = "mileage-clli.php?clli=<?php echo $clli; ?>"; // Redirect to URL.
});
</script>
