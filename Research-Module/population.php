...
<?php require_once('../cookie.php'); ?>
  ...
  <title>Network Population - UTOPIA</title>
    ...
    <div id="navbar">
      ...
      <?php
		    ...
		    if($org=='Longhaul') { 
		      ...
		      echo '<td><a href="../longhaul/project_add.php">Add Project</a></td>';
				  echo '<td><a href="../research/population.php">Link Circuit</a></td>';
          echo '<td><a href="../longhaul/search.php">Search</a></td>';
					echo '<td><a href="../longhaul/reports.php">Reporting</a></td>';
					echo '</tr>';
					echo '</table>';
					echo '</div>';
				}
...
$(document).ready(function() {
  ...
  $('#example tfoot th').each( function (i) {
    ...
    if(i==2||i==4||i==5||i==7||i==8||i==9||i==10)
...
<form method="post" action="population-manage.php">
  <table id="example" class="display" cellspacing="0" width="100%">
	...
	<?php 
		if(($org=='Longhaul')||($name=='Roxane Norris')) {

      echo 'Select All <input type="checkbox" id="selectAll" />';
      echo '</br></br>';
		}
	?>
  Project:
  <select name="project">
    ...
    <?php 
		if(($org=='Longhaul')||($name=='Roxane Norris')) { 
		  $resultProject= $mysqli->query("Select * from Longhaul_Projects order by PROJECT");
		  while($rowProject= $resultProject->fetch_assoc()) {
			
			  echo '<option value="'.$rowProject['ID'].'">' . $rowProject['PROJECT'] . '</option>';
      }
    }			
	...
	<?php 
		if(($org=='Longhaul')||($name=='Roxane Norris')) { echo '<input type="hidden" name="longhaul" value="y">'; }
	?>
  <input type="hidden" name="table" value="Population">
  <input type="checkbox" name="toForecast">Add to Tracking</br>
