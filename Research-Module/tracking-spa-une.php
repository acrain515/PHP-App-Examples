...
<script>
  $(function() { $( "#INITIAL_FOC" ).datepicker(); });
  $(function() { $( "#ACTUAL_FOC" ).datepicker(); });
</script>
</head>
...
<form method="post" action="tracking-spa-une.php">
...
<?php
  ...
  $e=0;
	...
	$query= "Select ID, INTERNAL_ORDER,SUBPROJECT,LATA,VENDOR_CKT_CLN, INTERNAL_CKT_CLN, VENDOR_CFA, STATUS, DATE_ADDED, INITIAL_FOC, NEW_VENDOR_CKT, PLANNER, NOGO, NOGO_REASON from Simple where INTERNAL_ORDER in ('SPA/UNE') $search $sort limit $limit";
...
<div style="width:300px;height:260px;padding:10px; border:1px solid #ccc;float:left;">
  <b>Update for Selected</b></br></br>
	<table style="border:0;">
	  <tr>
      <td style="font-weight:bold;border:0;">Status:</td>
			<td style="border:0;">
		...
		<tr>
		  <td style="font-weight:bold;border:0;">Planner:</td>
      <td style="border:0;">
			  <select style="width:160px;" name="PLANNER">
        <option value=""></option>
	      <?php 
		...
		<tr>
		  <td style="font-weight:bold;border:0;">Provisioner:</td>
      <td style="border:0;">
			  <select style="width:160px;" name="PROVISIONER">
        <option value=""></option>
	      <?php 
	        $resultProvisioner= $mysqli->query("Select NAME from Users where NAME!='Adam' order by NAME");
		      while($rowProvisioner= $resultProvisioner->fetch_assoc()) { 
		
		        $provisionerOption= $rowProvisioner['NAME'];
			
			      echo '<option value="'.$provisionerOption.'">'.$provisionerOption.'</option>';
		      }
        ...
        ?>
			...
			<tr>
        <td style="font-weight:bold;border:0;">Initial FOC:</td>
			  <td style="border:0;"><input type="text" id="INITIAL_FOC" name="INITIAL_FOC"></td>
		  </tr>
			<tr>
        <td style="font-weight:bold;border:0;">Actual FOC:</td>
			  <td style="border:0;"><input type="text" id="ACTUAL_FOC" name="ACTUAL_FOC"></td>
		  </tr>
			<tr>
        <td style="font-weight:bold;border:0;">Install PON:</td>
			  <td style="border:0;"><input type="text" name="INSTALL_PON"></td>
		  </tr>
			<tr>
        <td style="font-weight:bold;border:0;">Disc PON:</td>
			  <td style="border:0;"><input type="text" name="DISC_PON"></td>
		  </tr>
...
<div style="width:200px;height:100px;padding:10px;margin:0 10px;border:1px solid #ccc;float:left;">
  <div style="float:left;"><b>Import Edit</b></div>
	<div style="float:right;">
	...
	<div style="clear:both;"></div>
  <iframe style="height:80px;" src="import-edit-spa-une.php" frameborder="0" scrolling="no"></iframe>
</div>
