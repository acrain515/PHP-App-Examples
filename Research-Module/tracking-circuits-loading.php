...
<?php
  ...
  //remove this line and place only in containing page
...
<script>
$.post( "tracking-circuits-write.php?r=<?php echo $raisin; ?>", function( data ) {
     //$("#imgId").hide(); // Hide loading image.
	 
     window.location = "tracking-circuits-full.php"; // Redirect to URL.
});
</script>
